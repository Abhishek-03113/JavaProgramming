        ...
        if (args.length > 0) {
            ...
            switch (mode) {
                ...
                case "rider":
                    ...
                    try {
                        Class<?> riderClass = Class.forName("client.RiderClient");
                        riderClass.getMethod("main", String[].class).invoke(null, (Object) new String[0]);
                    } catch (Exception e) {
                ...
                case "driver":
                    ...
                    try {
                        Class<?> driverClass = Class.forName("client.DriverClient");
                        driverClass.getMethod("main", String[].class).invoke(null, (Object) new String[0]);
                    } catch (Exception e) {
