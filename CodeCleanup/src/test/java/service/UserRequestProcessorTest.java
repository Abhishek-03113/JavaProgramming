...
public class UserRequestProcessorTest {
    ...
    public void processSelection1Test() {
        ...
        assertNull(user.getSubcription());
    }
    ...
    public void processSelection2Test() {
        ...
        when(readerMock.getInput()).thenReturn("100.0");
    ...
    public void processSelection4Test() {
        ...
        assertEquals(BasepackTypes.GoldPack, user.getSubcription());
    }
    ...
    public void processSelection4Test2() {
        ...
        assertEquals(BasepackTypes.SilverPack, user.getSubcription());
    }
    ...
    public void processSelection6Test() {
        ...
        InputReader readerMock = mock(InputReader.class);
        when(readerMock.getInput()).thenReturn("test@gmail.com").thenReturn("1234567890");
